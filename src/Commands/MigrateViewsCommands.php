...
namespace Drupal\migrate_views\Commands;

use Drupal\Core\Entity\EntityTypeManagerInterface;
use Drupal\migrate_views\Plugin\migrate\id_map\MigrateViewsSql;
use Drupal\migrate_views\Traits\MigrateToolsCommandsTrait;
 ...
 */
class MigrateViewsCommands extends DrushCommands {
  ...
  /**
   * MigrateViewsCommands constructor.
   *
   ...
   * @default $options []
   *
   * @command migrate_views:generate
   *
   * @validate-module-enabled migrate_views
   *
   * @aliases migrate_views-generate
   *
   ...
   *
   * @usage migrate_views-cleanup-map-tables --all
   *   Drop source_data, destination_data columns from all migrate_map table(s).
   * @usage migrate_views-cleanup-map-tables --tables="migrate_map_articles"
   *   Drop source_data, destination_data columns from migrate_map_articles
   *   table.
   * @usage migrate_views-cleanup-map-tables --tables="migrate_map_articles, migrate_map_pages"
   *   Drop source_data, destination_data columns from migrate_map_articles
   *   and migrate_map_pages tables.
   *
   * @command migrate_views-cleanup-map-tables
   *
   * @aliases migrate_views-cleanup-map-tables, migrate_views-cleanup
   *
